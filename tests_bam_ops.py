...
class Test_bam_ops(unittest.TestCase):
    ...
    def test_group_flags(self):
        ...
        observed = "test_data/bam_ops/test_group_flags/test_group_flags_observed.bed"
        gen.remove_file(observed)
        flag_start = 3
        group_flags(input_bed, observed, flag_start)
        expected = gen.read_many_fields("test_data/bam_ops/test_group_flags/test_group_flags_expected.bed", "\t")
    ...
    def test_intersect_bed_default(self):
        ...
        expected_file = "test_data/bam_ops/test_intersect_bed_default/test_intersect_bed_default_expected.bed"
        observed_file = "test_data/bam_ops/test_intersect_bed_default/test_intersect_bed_default_observed.bed"
    ...
    def test_intersect_bed_default_bedops(self):
        ...
        expected_file = "test_data/bam_ops/test_intersect_bed_default_bedops/test_intersect_bed_default_bedops_expected.bed"
        observed_file = "test_data/bam_ops/test_intersect_bed_default_bedops/test_intersect_bed_default_bedops_observed.bed"
        gen.remove_file(observed_file)
    ...
    def test_intersect_bed_no_dups(self):
        ...
        expected_file = "test_data/bam_ops/test_intersect_bed_no_dups/test_intersect_bed_default_bedops_expected.bed"
        observed_file = "test_data/bam_ops/test_intersect_bed_no_dups/test_intersect_bed_no_dups_observed.bed"
        gen.remove_file(observed_file)
    ...
    def test_intersect_bed_hit_count(self):
        ...
        expected_file = "test_data/bam_ops/test_intersect_bed_hit_count/test_intersect_bed_hit_count_expected.bed"
        observed_file = "test_data/bam_ops/test_intersect_bed_hit_count/test_intersect_bed_hit_count_observed.bed"
        gen.remove_file(observed_file)
    ...
    def test_intersect_bed_hit_count_unsorted(self):
        ...
        expected_file = "test_data/bam_ops/test_intersect_bed_hit_count_unsorted/test_intersect_bed_hit_count_unsorted_expected.bed"
        observed_file = "test_data/bam_ops/test_intersect_bed_hit_count_unsorted/test_intersect_bed_hit_count_unsorted_observed.bed"
        gen.remove_file(observed_file)
        intersect_bed(A_file, B_file, output_file = observed_file, hit_count = True, no_dups = False)
        expected = gen.read_many_fields(expected_file, "\t")
        observed = gen.read_many_fields(observed_file, "\t")
    ...
    def test_intersect_bed_overlap(self):
        ...
        expected_file = "test_data/bam_ops/test_intersect_bed_overlap/test_intersect_bed_overlap_expected.bed"
        observed_file = "test_data/bam_ops/test_intersect_bed_overlap/test_intersect_bed_overlap_observed.bed"
        gen.remove_file(observed_file)
    ...
    def test_intersect_bed_force_strand(self):
        ...
        expected_file = "test_data/bam_ops/test_intersect_bed_force_strand/test_intersect_bed_force_strand_expected.bed"
        observed_file = "test_data/bam_ops/test_intersect_bed_force_strand/test_intersect_bed_force_strand_observed.bed"
        gen.remove_file(observed_file)
    ...
    def test_intersect_bed_force_strand_hit_count(self):
        ...
        expected_file = "test_data/bam_ops/test_intersect_bed_force_strand_hit_count/test_intersect_bed_force_strand_hit_count_expected.bed"
        observed_file = "test_data/bam_ops/test_intersect_bed_force_strand_hit_count/test_intersect_bed_force_strand_hit_count_observed.bed"
        gen.remove_file(observed_file)
    ...
    def test_intersect_bed_write_both(self):
        ...
        expected_file = "test_data/bam_ops/test_intersect_bed_write_both/test_intersect_bed_write_both_expected.bed"
        observed_file = "test_data/bam_ops/test_intersect_bed_write_both/test_intersect_bed_write_both_observed.bed"
        gen.remove_file(observed_file)
    ...
    def test_sort_bed(self):
        ...
        expected_file = "test_data/bam_ops/test_sort_bed/test_intersect_bed_A_file.bed"
        observed_file = "test_data/bam_ops/test_sort_bed/test_sort_bed_observed.bed"
        gen.remove_file(observed_file)
    ...
    def test_intersect_bed_intersect(self):
        ...
        expected_file = "test_data/bam_ops/test_intersect_bed_intersect/test_intersect_bed_intersect_expected.bed"
        observed_file = "test_data/bam_ops/test_intersect_bed_intersect/test_intersect_bed_intersect_observed.bed"
        gen.remove_file(observed_file)
    ...
    def test_intersect_bed_intersect_bedops(self):
        ...
        expected_file = "test_data/bam_ops/test_intersect_bed_intersect_bedops/test_intersect_bed_intersect_bedops_expected.bed"
        observed_file = "test_data/bam_ops/test_intersect_bed_intersect_bedops/test_intersect_bed_intersect_bedops_observed.bed"
        gen.remove_file(observed_file)
