...
process4 = ["python3", "disease_snps.py", "../source_data/clinvar_20180429.vcf.gz", "results/clinvar2", "results/clean_run_2/clean_run", "10000", "motif_sets/Ke400_eses.txt", "--ese_hit_simulation", "--only_disease"]
