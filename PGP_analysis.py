...
def main():
    ...
    args = [
        ...
        "use_old_sims",
        "out_of_frame",
        "simulate_ptcs_with_monomorphic",
        "generate_monomorphic_indices",
    ...
    args.genome_fasta, \
    args.bams_folder, \
    args.vcf_samples_file, \
    args.vcf_links_file, \
    args.vcf_folder, \
    args.panel_file, \
    args.out_prefix, \
    args.bam_analysis_folder, \
    args.number_of_simulations, \
    args.simulation_output_folder, \
    args.motif_file, \
    args.filter_genome_data, \
    args.get_SNPs, \
    args.process_bams, \
    args.simulate_ptc_snps, \
    args.motif_complement, \
    args.overwrite_intersect, \
    args.use_old_sims, \
    args.out_of_frame, \
    args.simulate_ptcs_with_monomorphic, \
    args.generate_monomorphic_indices, \
    ...
    if vcf_links_file != "None":
        links = gen.read_many_fields(vcf_links_file, "\t")
        vcf_links = {}
        for link in links:
